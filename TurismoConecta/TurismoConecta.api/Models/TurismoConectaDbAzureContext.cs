...
public partial class TurismoConectaDbAzureContext : DbContext
{
    public TurismoConectaDbAzureContext()
    {
    }

    public TurismoConectaDbAzureContext(DbContextOptions<TurismoConectaDbAzureContext> options)
        : base(options)
    {
    }
